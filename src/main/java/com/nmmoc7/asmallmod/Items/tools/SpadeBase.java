...
public class SpadeBase extends ItemSpade implements IAmItem {
    public SpadeBase(ToolMaterial material, String name, int color) {
        super(material);
        ...
        createTextures("spade", "items", name);
