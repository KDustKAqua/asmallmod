...
public class SwordBase extends ItemSword implements IAmItem {
    public SwordBase(ToolMaterial material, String name, int color) {
        super(material);
        ...
        createTextures("sword", "items", name);
